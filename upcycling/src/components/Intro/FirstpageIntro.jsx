...
return (
    <div>
        ...
        <div className='first_page_box'>
            <img className='first_intro_img' src="../../images/frontImg3.jpg" alt='소개img1'></img>
        ...
        <div className='second_page_box'>
            <img className='second_intro_img' src="../../images/frontImg3.jpg" alt='소개img2'></img>
        ...
        <div className='first_page_box'>
            <img className='first_intro_img' src="../../images/frontImg3.jpg" alt='소개img2'></img>
            <div className='first_intro_card'>
                <h2>What 3333?</h2>
                <p>업사이클링은 낭비라고 생각되는 것을 재활용하는 것입니다.</p>
                <p>업사이클링된 아이템은 종종 이전보다 더 기능적이거나 아름다워집니다.</p>  
